...
import 'package:ganesh_chaturthi/StatusList.dart';
import 'package:ganesh_chaturthi/widgets/CustomFBTextWidget.dart';
import 'package:ganesh_chaturthi/widgets/CustomFeatureCard.dart';
import 'package:ganesh_chaturthi/widgets/CustomFullCard.dart';
                    ...
                    children: [
                      DesignerContainer(
                        ...
                        child: Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Center(
                            child: Text("Messages in Marathi Hindi & English",
                                style: Theme.of(context).textTheme.headline1),
                          ),
                        ),
                      ),
                          ...
                          child: Row(
                            children: [
                              CustomGradientImageTextWidget(
                                ...
                                ontap: () {
                                  print("Marathi Message Clicked");
                                  interstitialTag = "marathi_message";
                                  facebookAppEvents.logEvent(
                                    name: "Message List",
                                    parameters: {
                                      'button_id': 'marathi_message_button',
                                    },
                                  );
                              ...
                              CustomGradientImageTextWidget(
                                ...
                                title: "हिन्दी",
                                bodyText:
                                    "भक्ति गणपति। शक्ति\nगणपति।सिद्दी गणपति,\nलक्ष्मी गणपतिमहा गणपति,\nदेवो में श्रेष्ठ मेरे\nगणपतिहैप्पी गणेश चतुर्थी",
                                bottomText: "पढ़ें",
                                color1: Colors.indigoAccent,
                                color2: Colors.indigo,
                                isleft: true,
                                imageUrl:
                                    "https://www.freepnglogos.com/uploads/ganesh-png/import-picture-lord-ganesh-png-file-0.png",
                                ontap: () {
                              ...
                              CustomGradientImageTextWidget(
                                ...
                                isleft: true,
                                imageUrl:
                                    "https://www.freepnglogos.com/uploads/ganesh-png/ganesh-png-pngforall-february-14.png",
                                ontap: () {
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Bappa Bhakti Shayari",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: QuotesDesign1(
                            size: size,
                            color: Colors.yellow,
                            bodyText: "भक्ति गणपति। शक्ति गणपति।\nसिद्दी गणपति, लक्ष्मी गणपति\nमहा गणपति, देवो में श्रेष्ठ मेरे गणपति\nगणेश चतुर्थी की हार्दिक शुभकामनाएं",
                            footerText: "Tap here to Read 54+ Shayari",
                            ontap: () {
                              print("Shayari Clicked");
                              interstitialTag = "shayari";
                              facebookAppEvents.logEvent(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CustomBannerWidget(
                          ...
                          topText: "Greetings for",
                          middleText: "Ganesh Chaturthi",
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Status for Social Media",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                              ...
                              child: Row(
                                children: [
                                  CustomGradientImageTextWidget(
                                    ...
                                    bodyText:
                                        "May you tread on the path\nof righteousnessas shown by\nLord Ganesh. Wishing you and\nyour family a very\nHappy Ganesh Chaturthi.",
                                    bottomText: "Read",
                                    color1: Colors.pinkAccent,
                                    color2: Colors.pink,
                                    isleft: false,
                                    imageUrl:
                                        "https://www.freepnglogos.com/uploads/ganesh-png/download-sri-ganesh-png-transparent-image-and-clipart-24.png",
                                    ontap: null,
                                  ),
                                  CustomGradientImageTextWidget(
                                    size: size,
                                    title: "Status for FB",
                                    bodyText:
                                        "May Lord Ganesha destroy all\nyour worries, sorrows, and\ntensions and fill your life\nwith love and happiness.\nHappy Ganesh Chaturthi!",
                                    bottomText: "Read",
                                    color1: Colors.indigoAccent,
                                    color2: Colors.indigo,
                                    isleft: false,
                                    imageUrl:
                                        "https://www.freepnglogos.com/uploads/ganesh-png/download-ganesh-transparent-background-png-image-17.png",
                                    ontap: null,
                                  ),
                                  CustomGradientImageTextWidget(
                                    size: size,
                                    title: "Bappa Status",
                                    bodyText:
                                        "खुशियो की सौगात आए, गणेश जी\nआपके पास आए। आपके जीवन\nमे आए सुख संपाति की बाहर,\nगणेश जी अपने साथ लाए\nधन सम्पति अपार।\nगणेश चतुर्थी की हार्दिक शुभकामनाये।",
                                    bottomText: "Read",
                                    color1: Colors.deepPurple,
                                    color2: Colors.deepPurpleAccent,
                                    isleft: false,
                                    imageUrl:
                                        "https://www.freepnglogos.com/uploads/ganesh-png/download-sri-ganesh-png-transparent-image-and-clipart-12.png",
                                    ontap: null,
                                  ),
                                ],
                              ),
